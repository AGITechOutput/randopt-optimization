...
昇腾平台
bash
python benchmark/ascend_demo_benchmark.py --model Qwen/Qwen2.5-7B-MoE --noise_strategy dynamic
...
bash
python benchmark/basic_benchmark.py --repeat 10 --save_result
...
直观展示“浅层小、深层大”的分层策略：
bash
python benchmark/basic_benchmark.py --visualize
...
bash
python benchmark/basic_benchmark.py --verbose
